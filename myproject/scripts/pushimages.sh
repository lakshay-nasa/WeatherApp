...
echo 'pushing image weatherapp'
${CONTAINER_RUNTIME} tag weatherapp ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/weatherapp
${CONTAINER_RUNTIME} push ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/weatherapp
